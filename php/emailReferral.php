...
<div style="margin-left:auto; margin-right:auto; max-width:600px;">
    ...
    <p style="margin: 10px 10px; font-family: Verdana, Arial, Helvetica, sans-serif; font-size: 14px;">
        The apps we create have the widest possible compatibility working on iOS, Andorid, Windows Phone, Blackberry 10, and in any current web browser. With apps starting at $350 we have a solution for any business!
	</p>
